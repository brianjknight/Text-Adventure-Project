...
public class Door implements Tangible {
    ...
    /**
     *  No parameters constructor default false and 1.
     *
     */
    public Door() {
        isOpen = false;
    ...
    /**
     * Constructor setting isOpen and level.
     * @param isOpen boolean if door is open or not.
     * @param level sets the doors key level.
     */
